...
| YOLO 分割模型 | ✅ 完成 | 12678 标注 | YOLO26s, val Mask mAP50-95=0.909, holdout=0.927 |
| 批量预测固化 | ✅ 完成 | 13195 书脊 | 517 张全量推理，4 种产物 |
| OCR 书名识别 | ✅ 完成 | 3342 书名 | Qwen3-VL-32B，297/297 张 |
| 馆藏匹配 + 去重计数 | ✅ 完成 | 96.7% 匹配率 | rapidfuzz + 主标题提取，12.4s |
...
│   └── catalog/                      #   馆藏目录 (xlsx + titles1.json + titles.json)
